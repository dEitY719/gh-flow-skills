...
dEitY719/gh-issue-skills#43) and routes on who wrote the spec. A trusted harness
starts the chain untouched; anything else takes a six-check validity review
first, and a BLOCK stops the run with **zero edits, zero commits, zero PRs**.

Procedure, judgment table, the six checks, block report:
`references/origin-trust-gate.md`.
